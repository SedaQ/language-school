...
//		userDao.save(user);
//		Assert.assertNotNull(em.find(Course.class, user.getId()));
//	}
//
//	@Test
//	public void testRemove() {
//		LSUser userToRemove = new LSUser();
//		user.setEmail("testToRemove@email.cz");
//		user.setPasswordHash("testHashtestHashtestHashtestHasdqewash7841267871s!@$%");
...
//		userDao.save(user);
//		Assert.assertEquals(user.getId(), userDao.findOne(user.getId()));
//	}
//
//	@Test
